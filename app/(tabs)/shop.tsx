...
const Shop = () => {
	...
	const events = [
		...
		items: [
			{name: "Match Ball", image: "https://cdn.theathletic.com/cdn-cgi/image/width=1200,height=900,fit=cover/app/uploads/2023/07/14081939/premier-league-ball-22-23-scaled.jpeg"},
			{name:"Signed Shirt", image:"https://thematchdayshop.com/cdn/shop/products/fa1b11_407f76bfd9a445acba98119707d22785_mv2.jpg"},
			{name:"Signed Shirt", image:"https://thematchdayshop.com/cdn/shop/products/fa1b11_407f76bfd9a445acba98119707d22785_mv2.jpg"},
			{name: "Match Ball", image: "https://cdn.theathletic.com/cdn-cgi/image/width=1200,height=900,fit=cover/app/uploads/2023/07/14081939/premier-league-ball-22-23-scaled.jpeg"}
	],
				...
				{events.map((event, idx) => (
					...
					<Card containerStyle={styles.card} key={idx}>	
						<Card.Image 
							...
							<Card.FeaturedSubtitle style={ styles.subtitle }>{event.type} • {event.location}</Card.FeaturedSubtitle>
						</Card.Image>
					</Card>
...
const styles = StyleSheet.create({
	...
	subcard: {
		...
		borderRadius: 10,
		image: {
			backgroundImage: "linear-gradient(to bottom, transparent, rgba(0,0,0,0.5) 90%, black)",
			borderRadius: 10,
			height: 90,
		},
		title: {
